...
public class ArtistSongLoader {
    ...
    public static ArrayList<SongsModel> getSongsForArtist(Context context, long artistID) {
        ...
        if ((cursor != null) && (cursor.moveToFirst()))
            do {
                ...
                songsList.add(new SongsModel(id, album, albumId, artist, duration, GlobalApp.INSTANCE.getImgUri(albumId), data, title, "", 0, size, trackNumber, artistId, 0));
            }
