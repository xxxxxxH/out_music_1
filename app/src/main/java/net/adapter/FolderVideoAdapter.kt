 ...
 * Desc :
 */
class FolderVideoAdapter : RecyclerView.Adapter<FolderVideoAdapter.MyViewHolder?> {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.txt_video_count.text = _data!![position].totalCount.toString() + " Videos"
    }
    ...
    companion object {
        var _data: List<FolderVideo>? = null
